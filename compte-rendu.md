...
- **[Romain](https://github.com/Rom1420)**
	<ul>
		...
		<ul>
		    ...
		    <li>Amélioration du style et des animations</li>
		    <li>Conception des composants pour les statistiques et les détails des parties</li>
		    <li>Gestion des boutons de difficulté et de la navigation</li>
		    <li>Intégration des composants de pré-jeu et de fin de jeu</li>
                    <li>Développemet de la page de statistiques détaillées et global</li>
		</ul>
	    </li>
	    <li><strong>Back-end</strong>:
		<ul>
		    <li>Filtrage et gestion des listes de mots</li>
